...
const QueryEnd = () => {
  ...
  return (
    <div className="queryend_container">
      ...
      <div>
        <MBTIProfile
          img={friendAns[0]?.friend_profile_image}
          friendResult={friendAns[0]?.friend_result}
          percent={friendAns[0]?.percent}
          userName={friendAns[0]?.friend_name}
        />
        <MBTIProfile
          img={friendAns[1]?.friend_profile_image}
          friendResult={friendAns[1]?.friend_result}
          percent={friendAns[1]?.percent}
          userName={friendAns[1]?.friend_name}
        />
        <MBTIProfile
          img={friendAns[2]?.friend_profile_image}
          friendResult={friendAns[2]?.friend_result}
          percent={friendAns[2]?.percent}
          userName={friendAns[2]?.friend_name}
        />
      </div>
